	...
	function insert_rule(country_codes, from, to, url_from, url_to, language_code, http_code, status) {
		...
		var $rule = $('<tr>')
			...
			.append($('<td>').append($from_list)
				.append('<div class="url-container" style="display:' + ((from == 'url') ? 'block' : 'none') + '"><input type="text" name="url_from[]" value="' + url_from + '" class="url regular-text" maxlength="255" /></div>')
				.append($('<div class="domain-container" style="display:' + ((from == 'domain') ? 'block' : 'none') + '">').append('<input type="text" name="domain_from[]" value="' + url_from + '" class="domain regular-text" maxlength="255" />').append($keep_query_input).append($keep_query_checkbox))
